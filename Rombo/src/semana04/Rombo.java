...
public class Rombo extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		double diaM, diaMe, area;
		diaM = Double.parseDouble(txtDiagonalMayor.getText());
		diaMe = Double.parseDouble(txtDiagonalMenor.getText());
		
		area = (diaM*diaMe)/2;
		
		txtS.setText("AREA :" + decimlFormat(area) + "\n");
	}
