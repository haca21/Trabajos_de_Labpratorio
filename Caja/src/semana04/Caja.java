...
public class Caja extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		double larg, anch,alt, volumen, area;
		larg = Double.parseDouble(txtLargo.getText());
		anch = Double.parseDouble(txtAncho.getText());
		 alt = Double.parseDouble(txtAlto.getText());
		 volumen = larg * anch * alt;
		 area = 2*(larg*anch+larg*alt*anch);
		 txtS.setText("VOLUMEN :" + decimlFormat(volumen) + "\n");
			imprimir("AREA :" + decimlFormat(area) + "\n");
	}
